...
?>
 ...
 <div class='cashback_view'>
    ...
    <h1 class="text-center text-white  big_title_h1 my-5 text-black">
		Support
    </h1>
    </div>
</div>
 <div class="section-padding bg-dark d-none">
         <div class="container">
            <div class="row align-items-center py-4">
               <div class="col-md-3">
                  <h1 class=" d-none text-primary display-4 font-weight-bold">How can<br/>Osahan Deel assistants <span class="text-warning">help</span> You?</h1>
                  <h5 class=" d-none mb-2 text-white-50 font-weight-light">We'd love to talk about how we can help you.
                  </h5>
               </div>
               <div class="col-md-6 col-md-push-3 p-5">
      ...
      <div class="pt-5 bg-white">
         ...
         if(isset($reponsError) && !empty($reponsConfirm)){
            ?>
         ...
         ?>
            <div class="row d-flex align-items-center">
               <div class="col-md-2 ">
                  <div class="d-none p-4 border mr-lg-4 rounded overflow-hidden">
                  <div class="d-none "style="overflow:hidden;width: 700px;position: relative;"><iframe width="700" height="440" src="https://maps.google.com/maps?width=700&amp;height=440&amp;hl=en&amp;q=Paris%2C%20France+(Titre)&amp;ie=UTF8&amp;t=&amp;z=10&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><div style="position: absolute;width: 80%;bottom: 10px;left: 0;right: 0;margin-left: auto;margin-right: auto;color: #000;text-align: center;"><small style="line-height: 1.8;font-size: 2px;background: #fff;">Powered by <a href="https://embedgooglemaps.com/fr/">embedgooglemaps FR</a> & <a href="http://botonmegusta.org/">botonmegusta.org/</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><br />
                   </div>
               </div>
               <div class="col-md-8">
                  <div class="mb-4 d-none">
                     <h4 class="font-weight-light mt-3">Tell us about <span class="font-weight-bold">yourself</span></h4>
                  ...
                  <form method='POST' class="bg-white p-5 contact-form" id="contact_form" method="post" action="" autocomplete="on">
                     ...
                     <div class="form-row">
                        ...
                        <div class="col">
                           <div class="form-group">
                              <label class="mb-1">YOUR MAIL <small class="text-danger">*</small></label>
                              <div class="position-relative icon-form-control">
                                 <input
                     ...
                     <input type="submit"  class="btn btn-primary text-uppercas" name="submit_send" id="submitContact" value="Envoyer le message" />
