<?php
	...
	if (!empty($_POST['submit_valider']))
	{
		...
		$pdo->exec("UPDATE gagnants SET etat = 'Valid&eacute;', code = '".$post_code."', dateSend = NOW() WHERE id = '".$sonid."' AND idUser = '".$sonidm."'") or die ('Erreur : '.mysql_error());
		...
		if ($infoUser_idParrain != 0) {
			...
			$pdo->exec("UPDATE users SET eurosParrain = eurosParrain + '".$montantParrain."' WHERE id = '".$sonidm."'") or die ('Erreur : '.mysql_error());
						...
						$headers .= "From: commande sur cashbackreduction.com <support@cashbackreduction.fr>\n";
                                                                ...
                                                                <td align="right" valign="middle" class="flexibleContainerBox">
                                                                        ...
                                                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                Vous avez passé une commande sur   <b> '.ucfirst(nom_site).' </b> Celle-ci a été traitée !<br/><br/>
                                                    
                                                                                Nous vous invitons à vous connecter à votre compte pour voir l\'état de votre commande.<br/><br/>
                                                                                                                
                                                                                &Agrave; bientôt sur  <b>'.ucfirst(nom_site).' </b>  !
