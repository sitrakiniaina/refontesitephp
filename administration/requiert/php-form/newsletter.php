<?php
	if (!empty($_POST['submit_newsletter'])) {
		if (isset($_POST['message'])) {
			...
			$headers .= "From: Newsletter cashbackreduction.com <newsletter@cashbackreduction.com>\n";
			$headers .= "Reply-To: No Reply <noreply@cashbackreduction.com>\n";

			$liste = $pdo->query("SELECT newLetter_email FROM newletter");
...
';
				...
				$Demail = $donnees['newLetter_email'];
				
				mail($Demail, 'New Letter', $messageM, $headers);
			}
