<?php
	...
	$meta_title = 'Panel d\'administration : Membres | cashbackreduction.com';
...
?>
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-light mb-4">
                        <h4 class="text-primary" >Les membres</h4>
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a href="membres.php" class="button btn-primary btn-icon-split">Retour</a>
                            </li>
                        </ul>
                    </nav>
            ...
            <div class="transaction-list">
                ...
                <div class="transaction-list-header">
                    <div  class="transaction-list-item-date admin-s1" style='width:40vh'>
                ...
                <div class="transaction-list-item" style="overflow: hidden;">
                    ...
                    <div class="transaction-list-item-date admin-s1">
                        <a  href="membres.php?action=<?= $dones_user['id']; ?>">
                            <div style='margin:1.25vh 0' class="button secondary">Voir le profil</div>
                        </a>
                    </div>
            ...
            <!-- /TRANSACTION LIST -->
                ...
                <a href=membres.php?page=<?php echo $page_p; ?>">
            ...
            <?php endif; ?>
                ...
                <a href="membres.php?page=<?php echo $page_s; ?>">
