                                                        ...
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    <h1 style="background-color: orange;padding: 1vh;border-radius: 4vh;color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:900;margin-bottom:5px;text-align:center;">
                                                                        CASHBACK REDUCTION
                                                                    </h1>
                                                                </td>
                                                            </tr>
